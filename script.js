...
const changequestion = function (event) {
    const innertext = documentgetElementById("feedbackQuestion").innerText
if (innertext === questions[0]) {
    document.getElementById("feedbackQuestion").innerText = questions[1]
    }if (innertext === questions[1]) {
        document.getElementById("feedbackQuestion").innerText = questions[2]   
    } else {
        document.getElementById("feedbackQuestion").innerText = questions[0]   
    }
